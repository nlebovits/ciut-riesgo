...
# URLs de GitHub como respaldo
ruta_twi_github = "https://github.com/nlebovits/ciut-riesgo/raw/refs/heads/main/notebooks/data/twi.tif"
ruta_peligro_github = "https://github.com/nlebovits/ciut-riesgo/raw/refs/heads/main/notebooks/data/peligro_raster_10m.tif"
...
# Intentar cargar archivos locales primero, luego GitHub como respaldo
try:
    m.add_raster(str(ruta_twi), colormap=CMAP, layer_name="TWI")
except:
    m.add_raster(ruta_twi_github, colormap=CMAP, layer_name="TWI")

try:
    m.add_raster(str(ruta_peligro), colormap=CMAP, layer_name="Peligrosidad")
except:
    m.add_raster(ruta_peligro_github, colormap=CMAP, layer_name="Peligrosidad")
