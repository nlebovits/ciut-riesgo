...
# Usar los xarray DataArrays directamente (sin archivos)
m.add_raster(twi_xarray, colormap=CMAP, layer_name="TWI")
m.add_raster(peligro_xarray, colormap=CMAP, layer_name="Peligrosidad")
