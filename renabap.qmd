...
COLUMN_MAPPINGS = {
    ...
    "peligrosid_to_peligrosidad": {"PELIGROSID": "peligrosidad"},
...
VISUALIZATION_CONFIG = {
    ...
    "alpha_default": 0.75,
    "alpha_buildings": 0.7,
    "peligrosidad_categories": ["baja", "media", "alta"],
    "plasma_cmap": plt.cm.plasma
}

# Color schemes for visualization
PELIGROSIDAD_COLORS = {
    "alta": plt.cm.plasma(0.8),
    "media": plt.cm.plasma(0.5),
    "baja": plt.cm.plasma(0.2),
}

METHOD_COLORS = {
    "areal": plt.cm.plasma(0.9),
    "ghsl": plt.cm.plasma(0.5),
    "edificios": plt.cm.plasma(0.1),
}
...
def setup_base_map(figsize=None, bounds=None, padding_x=None, padding_y=None):
    ...
    if figsize is None:
        figsize = VISUALIZATION_CONFIG["default_figsize"]
    if padding_x is None:
        padding_x = VISUALIZATION_CONFIG["padding_x"]
    if padding_y is None:
        padding_y = VISUALIZATION_CONFIG["padding_y"]
...
peligro_clipped_3857["PELIGROSID_ordered"] = pd.Categorical(
    ...
    categories=VISUALIZATION_CONFIG["peligrosidad_categories"],
    ordered=True,
)
...
peligro_clipped_3857.plot(
    ...
    cmap="plasma",
    alpha=VISUALIZATION_CONFIG["alpha_default"],
    legend=True,
    zorder=5,
)
...
plasma_cmap = VISUALIZATION_CONFIG["plasma_cmap"]
